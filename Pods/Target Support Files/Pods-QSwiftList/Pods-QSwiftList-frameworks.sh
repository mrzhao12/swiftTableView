...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/QTableKit/QTableKit.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/QUIAlertController/QUIAlertController.framework"
