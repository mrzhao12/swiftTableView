...
extension CommonUITableViewController {
    ...
    private func layoutCenterLoadingView() -> Bool {
        ...
        let myy = (tableHeaderViewMaxY + (tableView.bounds.size.height - insets.top - insets.bottom - tableHeaderViewMaxY - orgFrame.size.height) / 2 - centerLoadingViewPaddingBottom)
        centerLoadingView!.frame = CGRect(x: (self.tableView.bounds.size.width  - insets.left - insets.right - orgFrame.size.width) / 2, y: myy, width: orgFrame.size.width, height: orgFrame.size.height)
//        centerLoadingView!.frame = CGRect(x: (self.tableView.bounds.size.width  - insets.left - insets.right - orgFrame.size.width) / 2, y: (tableHeaderViewMaxY + (tableView.bounds.size.height - insets.top - insets.bottom - tableHeaderViewMaxY - orgFrame.size.height) / 2 - centerLoadingViewPaddingBottom), width: orgFrame.size.width, height: orgFrame.size.heigh)
